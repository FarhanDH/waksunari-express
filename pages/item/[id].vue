            ...
            <div class="md:flex gap-4 justify-between mx-auto w-full">
                ...
                <div class="md:w-[60%] bg-white p-3 rounded-lg">
                    ...
                    <div class="flex items-center pt-1.5">
                        <span
                            class="h-4 min-w-4 rounded-full p-0.5 bg-[#FFD000] mr-2"
                        >
                            <Icon
                        ...
                        <p class="text-[#FF5353]">Tambahan diskon 5%</p>
                    </div>
                    ...
                    <p class="text-[#009A66] text-xs font-semibold pt-1">
                        Gratis ongkir 11 hari dengan minimal belanja Rp 500.000
                    </p>
                    ...
                    >
                        <div v-if="isInCart">Telah Ditambahkan</div>
                        <div v-else>Masukkan Keranjang</div>
                    </button>
                </div>
            </div>
        </div>
