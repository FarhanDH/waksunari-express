            ...
            <div v-else class="md:flex gap-4 justify-between mx-auto w-full">
                <div class="md:w-[65%]">
                    <div class="bg-white rounded-lg p-4">
                        <div class="text-2xl font-bold mb-2">
                            Keranjang Belanja ({{ userStore.cart.length }})
                        </div>
                    </div>

                    <div class="bg-[#FEEEEF] rounded-lg p-4 mt-4">
                        <div class="text-red-500 font-bold">
                            Penawaran Selamat Datang hanya berlaku untuk 1 item
                            saja
                        </div>
                    </div>
                ...
                <div class="md:w-[35%]">
                    ...
                    >
                        ...
                        <p class="my-2">
                            Dapatkan pengembalian uang jika barang tidak sesuai
                            deskripsi atau jika tidak dikirimkan
                        </p>
                    </div>
                </div>
            </div>
